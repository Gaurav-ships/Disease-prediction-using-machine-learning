...
# Heading
w2 = Label(root, justify=CENTER, text="Disease Prediction using Machine Learning", fg="white", bg="grey")
w2.config(font=("Elephant", 40))
w2.grid(row=1, column=0, columnspan=3, padx=100)
w2 = Label(root, justify=CENTER, fg="white", bg="grey")
...
AgeLb = Label(root, text="Age of the Patient", fg="yellow", bg="black")
AgeLb.grid(row=7, column=1, pady=15, sticky=W)
...
dst = Button(root, text="DecisionTree", command=message,bg="green",fg="yellow")
dst.grid(row=16, column=2)


lr = Button(root, text="NaiveBayes", command=message1,bg="green",fg="yellow")
